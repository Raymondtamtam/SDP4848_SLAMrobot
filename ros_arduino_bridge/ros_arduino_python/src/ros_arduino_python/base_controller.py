...
class BaseController:
    def __init__(self, arduino, base_frame, name="base_controllers"):
        ...
        pid_params = dict()
        pid_params['wheel_diameter'] = rospy.get_param("~wheel_diameter", "0.065") 
        pid_params['wheel_track'] = rospy.get_param("~wheel_track", "0.21")
        pid_params['encoder_resolution'] = rospy.get_param("~encoder_resolution", "1320") 
        pid_params['gear_reduction'] = rospy.get_param("~gear_reduction", 1.0)
        pid_params['Kp'] = rospy.get_param("~Kp", 2)
